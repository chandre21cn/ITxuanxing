...
<head>
    ...
    <style>
        ...
        .preview1 {width:160px; height: 160px; }
        .preview2 {width:80px; height: 80px; margin: 20px 0}
        .preview3 {width:30px; height: 30px;}
    </style>
</head>
<body>
    ...
    <div>
        <a href="javascript:void(0)" class="edit-avatar"><img src="http://www.cio.com.cn/avatar/big/3249" alt="" width="80" height="80"></a>
    </div>
