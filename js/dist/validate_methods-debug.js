 ...
 */
define("base/common/1/validate_methods-debug", [ "sea-modules/jquery/jquery-debug", "sea-modules/lib/validate-debug" ], function(require, exports, module) {
    var $ = require("sea-modules/jquery/jquery-debug"), validate = require("sea-modules/lib/validate-debug");
    var Exp = {
        email: /^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/,
        //邮箱
