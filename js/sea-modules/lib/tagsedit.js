/**
 * Created by chandre on 14-9-29.
 */
define(function(require, exports, module) {
    var jQuery = require('$');
    var AutoComplete = require('./autocomplete');
    (function($){
        $.fn.autoGrowInput=function(o){o=$.extend({maxWidth:250,minWidth:20,comfortZone:0},o);this.filter('input:text').each(function(){var minWidth=o.minWidth||$(this).width(),val=' ',input=$(this),comfortZone=o.comfortZone?o.comfortZone:parseInt(parseInt($(this).css('fontSize'))*0.9)});return this;};
        ...
        $.fn.tagEditor = function(options, val, next){
            ...
            if (typeof options == 'string') {
                ...
                selector.each(function(){
                    ...
                    if (options == 'getTags')
                        ...
                        // insert new tag
                        $('<li><div class="tag-editor-tag"></div><div class="tag-editor-delete"><i></i></div><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div></li>').appendTo(ed).find('.tag-editor-tag')
            ...
            return selector.each(function(){
                ...
                // markup for new tag
                var new_tag = '<li><div class="tag-editor-tag"></div><div class="tag-editor-delete"><i></i></div><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div></li>';
                ...
                ed.on('click', '.tag-editor-tag', function(e){
                    ...
                    if (!$(this).hasClass('active')) {
                        ...
                        if (o.autocomplete) {
                            ...
                            input.AutoComplete(o.autocomplete);
                        }
                    }
                    return false;
                });
                ...
                function split_cleanup(input){
                    ...
                    for (i in sub_tags) {
                        ...
                        if (tag) {
                            ...
                            old_tags.push(tag);
                            li.before('<li><div class="tag-editor-tag">'+tag+'</div><div class="tag-editor-delete"><i></i></div><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div></li>');
                        }
                    }
                ...
                for (i in tags) {
                    ...
                    if (tag) {
                        //if (o.forceLowercase) tag = tag.toLowerCase();
                        tag_list.push(tag);
                        ed.append('<li><div class="tag-editor-tag">'+tag+'</div><div class="tag-editor-delete"><i></i></div><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div></li>');
                    }
                }
